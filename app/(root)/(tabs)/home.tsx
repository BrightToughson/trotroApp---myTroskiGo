...
const styles = StyleSheet.create({
  ...
  headerIconBtn: { width: 40, height: 40, borderRadius: 12, justifyContent: "center", alignItems: "center", elevation: 4 },
  searchTrigger: { flexDirection: "row", alignItems: "center", minHeight: 76, paddingVertical: 12, paddingHorizontal: 16, borderRadius: 24, borderWidth: 1.5, ...Platform.select({ web: {}, default: { elevation: 8, shadowColor: "#3b82f6", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.04, shadowRadius: 12 } }) },
  ...
  searchIconBox: { width: 44, height: 44, borderRadius: 12, justifyContent: "center", alignItems: "center" },
  swiperContainer: { marginTop: 8 },
  newsCard: { flex: 1, borderRadius: 28, overflow: "hidden", borderWidth: 1, ...Platform.select({ web: {}, default: { elevation: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.3, shadowRadius: 20 } }) },
  ...
  liveLabel: { fontSize: 14, fontWeight: '900', letterSpacing: 1.2, marginBottom: 2 },
  liveText: { fontSize: 16, fontWeight: '600' },
  newsTagText: { color: "#fff", fontSize: 11, fontWeight: "900", letterSpacing: 1.2, textTransform: "uppercase" },
  newsContentOverlay: { paddingVertical: 20, paddingHorizontal: Platform.OS === 'web' ? 48 : 20, paddingBottom: 36, marginTop: "auto" },
  newsTitlePremium: { fontSize: 22, fontWeight: "900", color: "#fff", letterSpacing: -0.2, lineHeight: 28, textShadowColor: 'rgba(0,0,0,0.4)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 6 },
  newsExcerptPremium: { color: "rgba(255,255,255,0.85)", fontSize: 14, fontWeight: "500", marginTop: 12, lineHeight: 20, textShadowColor: 'rgba(0,0,0,0.3)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
